				...
				<div id="horizontalTab">
					...
					<div class="resp-tabs-container">
						<div class="agileits_w3layouts_tab1">
							<form action="Paymentservlet" method="post" class="creditly-card-form agileinfo_form">
								<section class="creditly-wrapper wthree, w3_agileits_wrapper">
									<div class="credit-card-wrapper">
										<div class="first-row form-group">
											<div class="controls">
												<label class="control-label">NAME    :</label>
                                                                                                <input class="billing-address-name form-control" type="text" name="phone" placeholder="<%=a.getUser()%>" readonly>
										</div>
                                                                                  
                                                                                    <div class="controls">
												<label class="control-label">ADDRESS :</label> <a href="changeaddress.jsp">change address</a>
                                                                             <input class="billing-address-name form-control" type="text" name="phone" value="<%=a.getAddress()%>" readonly>

											</div>
                                                                                    <div class="controls">
												<label class="control-label">STATE   :</label> 
												<input class="billing-address-name form-control" type="text" name="phone" value="<%=a.getState()%>" readonly>
											</div>
                                                                                                  <div class="controls">
												<label class="control-label">PIN CODE :</label>
												<input class="billing-address-name form-control" type="text" name="phone" value="<%=a.getPincode()%>" readonly>
											</div>
											
                                                                                        <button class="submit "><span>payment</span></button> 
									</div>
								</section>
							</form>
						</div>
