...
<body>
	...
	<div class="header" id="home1">
		<div class="container">
			...
			<div class="w3l_logo">
				<h1><a href="index1.jsp">Electronic Store<span>Your stores. Your place.</span></a></h1>
			</div>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						<li><a href="Sessioncheckservlet" class="act">Home</a></li>	
						<!-- Mega Menu -->
						<li class="dropdown">
								...
								<div class="row">
									<div class="col-sm-3">
										<ul class="multi-column-dropdown">
											<h6>Clothes</h6>
											<li><a href="menswear.jsp">MENSWEAR</a></li>
											<li><a href="products.jsp">WOMENSWEAR <span>New</span></a></li> 
